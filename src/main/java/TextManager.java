...
public class TextManager {
    ...
    public List<Sentence> splitText(String text) throws Exception {
        ...
        //общеприн€тые сокращени€ без точки
    ...
    /**
     * ѕодгрузка значений сокращений из Ѕƒ, если не найдет, то это не сокращение
     */
    ...
    /**
     * »щет общеприн€тые сокращени€ без точки, сто€щие после чисел.
     */
